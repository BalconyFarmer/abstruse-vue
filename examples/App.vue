        ...
        <div class="mainFirst">
            ...
            <div class="right">
                ...
                <div v-if="route == 1" class="rightMain ">
                    <A_1PictureTree></A_1PictureTree>
                </div>

                <div v-if="route == 2" class="rightMain ">
                    <A_2BarChart></A_2BarChart>
                </div>
...
import A_0Init from "./views/A_0Init";

import "../lib/index.css";

import A_1PictureTree from "./views/A_1WaterBall";

// import PictureTree from "../packages/abstruse-vue/vueConponents/PictureTree/PictureTree";
...
export default {
    components: {
        A_0Init, ThreeNumInGrid, PictureTree, ScrollTable, fiveNumber, A_1PictureTree, A_2BarChart
    },
    data: function () {
        return {
            route: 0,
